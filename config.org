...
(defadvice +eval/send-region-to-repl (around my-send-region-to-repl activate)
  (if (and (eq major-mode 'org-mode)
      ...
      (progn
        (yejun/ensure-kitty-nix-repl-tab)
        (yejun/send-region-to-kitty-nix-repl-tab))
    ad-do-it))
#+end_src
