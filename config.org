...
(map! :leader
      (:prefix-map ("o p" . "pass")
       ...
       :desc "Insert OTP"            "I" #'yejun/password-store-otp-insert
       :desc "Append OTP"            "a" #'yejun/password-store-otp-append
...
(setq send-mail-function 'smtpmail-send-it
      ...
      smtpmail-smtp-user "goofan.su@gmail.com"
...
(map! :leader
      "fn" #'yejun/find-file-in-nix-config)
#+end_src
